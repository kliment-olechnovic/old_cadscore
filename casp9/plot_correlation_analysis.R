...
output_directory="plot_correlation_analysis";
...
for(score_name in cadscore_names)
{
    ...
    plot(x=x, y=y, xlim=c(0, 1), ylim=c(0, 1), col=blue_density_colors, pch=16, cex=0.5, xlab="GDT_TS", ylab=score_name, main=paste(score_name, " correlation with GDT_TS", sep=""));

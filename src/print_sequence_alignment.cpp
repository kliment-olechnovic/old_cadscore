...
template<typename T>
void print_sequence_alignment(const T& seq1, const T& seq2, const SequenceAlignment::AlignmentResult& alignment_result)
{
...
void print_sequence_alignment(const auxiliaries::CommandLineOptions& clo)
{
	...
	{
		SequenceAlignment::SimpleScorer scorer(2, -1, -1);
		std::cout << "\nglobal:\n";
		print_sequence_alignment(seq1, seq2, SequenceAlignment::align_two_sequences(seq1, seq2, scorer, false));
		std::cout << "\nlocal:\n";
		print_sequence_alignment(seq1, seq2, SequenceAlignment::align_two_sequences(seq1, seq2, scorer, true));
		std::cout << "\n";
	}
}

#ifndef INTER_RESIDUE_CONTACTS_CONSTRUCTION_H_
#define INTER_RESIDUE_CONTACTS_CONSTRUCTION_H_
...
std::map< InterResidueContactID<ResidueID>, InterResidueContactAreas > construct_inter_residue_contacts(const std::vector<Atom>& atoms, const std::vector<InterAtomContact>& inter_atom_contacts)
{
...
#endif /* INTER_RESIDUE_CONTACTS_CONSTRUCTION_H_ */

...
png(paste(output_directory, "/vertices_differences.png", sep=""), height=8, width=8, units="in", res=600);
par(mfrow=c(2,2));
...
hist(vds, breaks=seq(-86, 86, 4), xlim=c(0-60, 60), main="", xlab="Difference", col="red");
